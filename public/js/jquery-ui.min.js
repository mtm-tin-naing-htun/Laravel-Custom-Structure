...
((t) => {
    ...
    (V.cleanData =
        ...
        (V.widget = function (t, i, e) {
            ...
            return "__proto__" === (t = t.split(".")[1]) || "constructor" === t
                ...
                : ((a = l + "-" + t),
                  e || ((e = i), (i = V.Widget)),
                  Array.isArray(e) &&
                      (e = V.extend.apply(null, [{}].concat(e))),
        ...
        (V.widget.extend = function (t) {
            for (
                var e, i, s = c.call(arguments, 1), n = 0, o = s.length;
                n < o;
                n++
            )
                for (e in s[n])
        ...
        (V.ui.position = {
            fit: {
                left: function (t, e) {
                    ...
                    s < e.collisionWidth
                        ? 0 < a && r <= 0
                            ? ((i = t.left + a + e.collisionWidth - s - n),
                              (t.left += a - i))
                            : (t.left =
                                  !(0 < r && a <= 0) && r < a
                                      ? n + s - e.collisionWidth
                                      : n)
                        : 0 < a
                        ? (t.left += a)
                        : 0 < r
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[0];
                    a < 0
                        ? ((n = t.left + r + l + h + e.collisionWidth - n - s) <
                              0 ||
                              n < k(a)) &&
                          (t.left += r + l + h)
                        : 0 < o &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[1];
                    a < 0
                        ? ((n = t.top + r + l + h + e.collisionHeight - n - s) <
                              0 ||
                              n < k(a)) &&
                          (t.top += r + l + h)
                        : 0 < o &&
            ...
            (V.effects.define("blind", "hide", function (t, e) {
                ...
                (a.clip[i[n][0]] = a.clip[i[n][1]]),
                    "show" === t.mode &&
                        ...
                        (a.clip = o)),
                    r &&
                        r.animate(V.effects.clipToBox(a), t.duration, t.easing),
                    s.animate(a, {
                        queue: !1,
                        duration: t.duration,
                        easing: t.easing,
            ...
            V.effects.define("bounce", function (t, e) {
                ...
                for (
                    V.effects.createPlaceholder(n),
                        ...
                        l =
                            l ||
                            n["top" == p ? "outerHeight" : "outerWidth"]() / 3,
                        o &&
                            (((s = { opacity: 1 })[p] = r),
                            n
                                .css("opacity", 0)
                    ...
                    i
                        .queue(function (t) {
                            h &&
                                h
                                    .animate(
                                        V.effects.clipToBox(u),
                                        l,
                                        e.easing
                                    )
                                    .animate(
                                        V.effects.clipToBox(d),
                                        l,
                                        e.easing
                                    ),
                                t();
            ...
            V.effects.define("size", function (s, e) {
                ...
                V.effects.createPlaceholder(i),
                    ...
                    c &&
                        ...
                        (g.left =
                            (p.outerWidth - g.outerWidth) * r.x + d.left)),
            ...
            V.effects.define("scale", function (t, e) {
                var i = V(this),
                    ...
                    s =
                        ...
                        (0 === parseInt(t.percent, 10) || "effect" !== s
                            ? 0
                            : 100),
                    i = V.extend(
                        !0,
            ...
            (V.ui.formResetMixin = {
                ...
                _bindFormResetHandler: function () {
                    ...
                    (this.form = V(this.element.prop("form"))),
                        this.form.length &&
                            ((t =
                                this.form.data("ui-form-reset-instances") || [])
                                .length ||
                                this.form.on(
                                    "reset.ui-form-reset",
            ...
            V.widget("ui.accordion", {
                    ...
                    t.preventDefault(),
                        (n && !e.collapsible) ||
                            ...
                            e.icons &&
                                ...
                                )._addClass(a, null, e.icons.header)),
                            n) ||
                            (this._removeClass(
                                s,
                                "ui-accordion-header-collapsed"
                            ...
                            e.icons &&
                                ...
                                this._removeClass(
                                    ...
                                    null,
                                    e.icons.header
                                )._addClass(t, null, e.icons.activeHeader)),
                            this._addClass(
                                s.next(),
                                "ui-accordion-content-active"
                            ));
                ...
                _animate: function (t, i, e) {
                    ...
                    var n,
                        ...
                        l = (l && h.down) || h,
                        c =
                            (c = "string" == typeof l ? l : c) ||
                            l.easing ||
                            h.easing,
                        u =
                            (u = "number" == typeof l ? l : u) ||
                            l.duration ||
                            h.duration;
                    return i.length
                        ? t.length
            ...
            V.widget("ui.menu", {
                ...
                _create: function () {
                    (this.activeMenu = this.element),
                        ...
                        this._on({
                            ...
                            focus: function (t, e) {
                                var i =
                                    this.active || this._menuItems().first();
                                e || this.focus(t, i);
                            },
                            blur: function (t) {
                ...
                _scrollIntoView: function (t) {
                    ...
                    this._hasScroll() &&
                        ...
                        (i =
                            parseFloat(
                                V.css(this.activeMenu[0], "paddingTop")
                            ) || 0),
                        (e =
                            t.offset().top -
            ...
            V.widget("ui.autocomplete", {
                ...
                _create: function () {
                    ...
                    (this.isMultiLine =
                        e ||
                        (!t &&
                            "true" === this.element.prop("contentEditable"))),
                        (this.valueMethod =
                            this.element[e || t ? "val" : "text"]),
                        (this.isNewMenu = !0),
                                ...
                                /^mouse/.test(t.originalEvent.type)
                                    ...
                                    : ((s = e.item.data(
                                      ...
                                      !1 !==
                                          ...
                                          this._value(s.value),
                                      (i =
                                          e.item.attr("aria-label") ||
                                          s.value) &&
                                          String.prototype.trim.call(i)
                                              .length &&
                ...
                _renderItemData: function (t, e) {
                    return this._renderItem(t, e).data(
                        "ui-autocomplete-item",
                        e
                    );
                },
            ...
            V.ui.formResetMixin,
            {
                ...
                _getCreateOptions: function () {
                    ...
                    return (
                        ...
                        (this.originalLabel = ""),
                        (t = this.label.contents().not(this.element[0]))
                            .length &&
        ...
        V.extend(nt.prototype, {
                        ...
                        v = function (t, e, i) {
                            ...
                            if (
                                (V.each(t, function (t, e) {
                                    var i = e[1];
                                    if (
                                        n.substr(o, i.length).toLowerCase() ===
                                        i.toLowerCase()
                                    )
            ...
            _generateHTML: function (t) {
                ...
                for (
                    t.drawMonth = A,
                        ...
                        S = T
                            ? this.formatDate(S, I, this._getFormatConfig(t))
                            : S,
                        M = "",
                        t.inline ||
                            (M = V("<button>")
                    ...
                    for (d = "", this.maxRows = 4, p = 0; p < P[1]; p++) {
                        ...
                        for (
                            m += _ + "</tr></thead><tbody>",
                                ...
                                v =
                                    (this._getFirstDayOfMonth(E, A) - n + 7) %
                                    7,
                                b = Math.ceil((v + b) / 7),
                            ...
                            for (
                                ...
                                (w = a
                                    ? a.apply(t.input ? t.input[0] : null, [y])
                                    : [!0, ""]),
                                    (k =
                                        ((x = y.getMonth() !== A) && !R) ||
                                        !w[0] ||
            ...
            _canAdjustMonth: function (t, e, i, s) {
                ...
                return (
                    e < 0 &&
                        i.setDate(
                            this._getDaysInMonth(i.getFullYear(), i.getMonth())
                        ),
                    this._isInRange(t, i)
                );
            },
    ...
    V(document).on("mouseup", function () {
                    ...
                    e.containment
                        ? "window" === e.containment
                            ? (this.containment = [
                                  ...
                                  V(window).scrollTop() +
                                      (V(window).height() ||
                                          i.body.parentNode.scrollHeight) -
                                      this.helperProportions.height -
                                      this.margins.top,
                              ])
        ...
        V.widget("ui.resizable", V.ui.mouse, {
            ...
            _mouseStart: function (t) {
                ...
                return (
                    ...
                    this._helper ||
                        (s = this._calculateAdjustedElementDimensions(o)),
                    ...
                    this._helper &&
                        ...
                        (s =
                            parseFloat(o.element.css("top")) +
                                (o.position.top - o.originalPosition.top) ||
                            null),
                        n.animate ||
            ...
            _updateVirtualBoundaries: function (t) {
                var e,
                    ...
                    n = {
                        ...
                        maxWidth: this._isNumber(n.maxWidth)
                            ? n.maxWidth
                            : 1 / 0,
                        minHeight: this._isNumber(n.minHeight)
                            ? n.minHeight
                            : 0,
                        maxHeight: this._isNumber(n.maxHeight)
                            ? n.maxHeight
                            : 1 / 0,
                    };
                (this._aspectRatio || t) &&
            ...
            _calculateAdjustedElementDimensions: function (t) {
                ...
                return "content-box" !== t.css("box-sizing") ||
                    ...
                    : ((e = parseFloat(s.style.width)),
                      ...
                      (e = isNaN(e)
                          ? this._getElementTheoreticalSize(t, i, "width")
                          : e),
                      {
                          height: isNaN(s)
        ...
        V.widget("ui.dialog", {
            ...
            _createTitlebar: function () {
                ...
                var t =
                        Number.isInteger(
                            this.options.uiDialogTitleHeadingLevel
                        ) &&
            ...
            _trackingInstances: function () {
                ...
                return (
                    t || this.document.data("ui-dialog-instances", (t = [])), t
                );
            },
            _minHeight: function () {
                var t = this.options;
    ...
    V.ui.droppable,
        ...
        V.widget("ui.slider", V.ui.mouse, {
                    ...
                    (this._clickOffset = a
                        ...
                        : {
                              ...
                              top:
                                  ...
                                  (parseInt(n.css("borderBottomWidth"), 10) ||
                                      0) +
            ...
            _values: function (t) {
                ...
                if (arguments.length)
                    return (
                        (t = this.options.values[t]), this._trimAlignValue(t)
                    );
                            ...
                            (s && !o.forcePlaceholderSize) ||
                                ...
                                e.width(
                                    i.currentItem.innerWidth() -
                                        parseInt(
                                            i.currentItem.css("paddingLeft") ||
                                                0,
                                            10
                                        ) -
                                        parseInt(
                                            i.currentItem.css("paddingRight") ||
                                                0,
                                            10
                                        )
                                );
            ...
            _generatePosition: function (t) {
                ...
                return (
                    ...
                    this.originalPosition &&
                        ...
                        ((t =
                            this.originalPageY +
                            Math.round((s - this.originalPageY) / e.grid[1]) *
                                e.grid[1]),
                        (s =
                            !this.containment ||
                        ...
                        (t =
                            this.originalPageX +
                            Math.round((i - this.originalPageX) / e.grid[0]) *
                                e.grid[0]),
                        (i =
                            !this.containment ||
    ...
    V.ui.spinner,
        V.widget("ui.tabs", {
            ...
            _activate: function (t) {
                ...
                t[0] !== this.active[0] &&
                    ((t = (t = t.length ? t : this.active).find(
                        ".ui-tabs-anchor"
                    )[0]),
                    this._eventHandler({
                        target: t,
        ...
        V.widget("ui.tooltip", {
            ...
            open: function (t) {
                var i = this,
                    e = V(t ? t.target : this.element).closest(
                        this.options.items
                    );
                e.length &&
                    !e.data("ui-tooltip-id") &&
                    (e.attr("title") &&
                        e.data("ui-tooltip-title", e.attr("title")),
                ...
                i &&
                    ((o = this._find(e))
                        ...
                        : (e.is("[title]") &&
                          ...
                          (o = V("<div>").html(
                              s.find(".ui-tooltip-content").html()
                          ))
                              .removeAttr("name")
                              .find("[name]")
                              .removeAttr("name"),
